   ...
   # psi[psi<-eta_u] = -eta_u;
    ...
    if(1):
       ...
       # c1.update_bruteforce(handle);
        np.save('/home/joymm/VaporS1-3sec/rh_data_'+str(sec)+'.npy',rh.transpose());
        np.save('/home/joymm/VaporS1-3sec/vapor_data_'+str(sec)+'.npy',vapor_n.transpose());
        handle3.set_array(rh.transpose());
        handle3.autoscale();
        np.save('/home/joymm/VaporS1-3sec/eta_data_'+str(sec)+'.npy',omega_n.transpose());
